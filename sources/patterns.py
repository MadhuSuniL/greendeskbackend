...
def expression_patterns(expression):
    ...
    text_variations = [
        f"The result of {expression} is <strong class = 'text-xl text-green-300'>{numeric_answer}</strong>.",
        f"After evaluating {expression}, we find the answer to be <strong class = 'text-xl text-green-300'>{numeric_answer}</strong>.",
        f"The solution to {expression} is <strong class = 'text-xl text-green-300'>{numeric_answer}</strong>.",
        f"Upon solving {expression}, we obtain the result <strong class = 'text-xl text-green-300'>{numeric_answer}</strong>.",
        f"The expression {expression} yields <strong class = 'text-xl text-green-300'>{numeric_answer}</strong> as the solution.",
        f"After computation, {expression} results in <strong class = 'text-xl text-green-300'>{numeric_answer}</strong>.",
        f"Confirming the calculations for {expression}, we arrive at the solution: <strong class = 'text-xl text-green-300'>{numeric_answer}</strong>.",
        f"Considering the context of {expression}, the solution is <strong class = 'text-xl text-green-300'>{numeric_answer}</strong>.",
        f"From our computations on {expression}, it can be concluded that the solution is <strong class = 'text-xl text-green-300'>{numeric_answer}</strong>.",
        f"In the context of {expression}, the answer is <strong class = 'text-xl text-green-300'>{numeric_answer}</strong>.",
        f"The expression {expression} evaluates to <strong class = 'text-xl text-green-300'>{numeric_answer}</strong>.",
        f"After solving {expression}, we get <strong class = 'text-xl text-green-300'>{numeric_answer}</strong>.",
        f"Evaluating {expression} yields the result <strong class = 'text-xl text-green-300'>{numeric_answer}</strong>.",
        f"The correctness of the result for {expression} is affirmed, and the answer is <strong class = 'text-xl text-green-300'>{numeric_answer}</strong>.",
        f"Verification of {expression} yields the solution <strong class = 'text-xl text-green-300'>{numeric_answer}</strong>.",
        f"{expression} evaluates to <strong class = 'text-xl text-green-300'>{numeric_answer}</strong>.",
        f"<strong class = 'text-xl text-green-300'>{numeric_answer}</strong> is the solution to {expression}.",
        f"We find that the answer to {expression} is <strong class = 'text-xl text-green-300'>{numeric_answer}</strong>.",
        f"The result of {expression} is <strong class = 'text-xl text-green-300'>{numeric_answer}</strong>.",
        f"Upon solving {expression}, we find the answer to be <strong class = 'text-xl text-green-300'>{numeric_answer}</strong>.",
        f"The solution to {expression} is <strong class = 'text-xl text-green-300'>{numeric_answer}</strong>.",
        f"Considering the context of {expression}, the answer is <strong class = 'text-xl text-green-300'>{numeric_answer}</strong>.",
        f"From our computations on {expression}, it can be concluded that the solution is <strong class = 'text-xl text-green-300'>{numeric_answer}</strong>.",
        f"In the context of {expression}, the answer is <strong class = 'text-xl text-green-300'>{numeric_answer}</strong>.",
        f"After solving {expression}, we get <strong class = 'text-xl text-green-300'>{numeric_answer}</strong>.",
        f"Evaluating {expression} yields the result <strong class = 'text-xl text-green-300'>{numeric_answer}</strong>.",
...
,
 {
   ...
   "responses": [
      "<strong class='text-green-300 text-xl'>Madhu</strong>, who is a Python Full Stack Developer, developed me.",
      "Developed by <strong class='text-green-300 text-xl'>Madhu</strong>, a Python Full Stack Developer.",
      "I was created by <strong class='text-green-300 text-xl'>Madhu</strong>, a skilled Python Full Stack Developer.",
      "<strong class='text-green-300 text-xl'>Madhu</strong>, the Python Full Stack Developer, is responsible for my development.",
      "I owe my existence to <strong class='text-green-300 text-xl'>Madhu</strong>, who is proficient in Python Full Stack development.",
      "The brains behind my development belong to <strong class='text-green-300 text-xl'>Madhu</strong>, a Python Full Stack Developer.",
      "My creator, <strong class='text-green-300 text-xl'>Madhu</strong>, is an accomplished Python Full Stack Developer.",
      "Crafted by <strong class='text-green-300 text-xl'>Madhu</strong>, a professional in Python Full Stack development.",
      "<strong class='text-green-300 text-xl'>Madhu</strong>, the talented Python Full Stack Developer, brought me to life.",
      "I'm the result of <strong class='text-green-300 text-xl'>Madhu</strong>'s expertise in Python Full Stack development.",
      "The mastermind behind me is <strong class='text-green-300 text-xl'>Madhu</strong>, a skilled Python Full Stack Developer.",
      "My creators are the brilliant minds at the hands of <strong class='text-green-300 text-xl'>Madhu</strong>, a Python Full Stack Developer.",
      "<strong class='text-green-300 text-xl'>Madhu</strong>, with expertise in Python Full Stack development, is my creator.",
      "The credit for my creation goes to <strong class='text-green-300 text-xl'>Madhu</strong>, a Python Full Stack Developer.",
      "I was developed by <strong class='text-green-300 text-xl'>Madhu</strong>, a professional in Python Full Stack development.",
      "The genius behind my existence is <strong class='text-green-300 text-xl'>Madhu</strong>, a Python Full Stack Developer.",
      "<strong class='text-green-300 text-xl'>Madhu</strong>, the skilled mind in Python Full Stack development, is my creator.",
      "I owe my creation to <strong class='text-green-300 text-xl'>Madhu</strong>, a Python Full Stack Developer with immense talent.",
      "<strong class='text-green-300 text-xl'>Madhu</strong>, a proficient Python Full Stack Developer, is the architect of my being.",
      "The magic of my creation comes from <strong class='text-green-300 text-xl'>Madhu</strong>, a Python Full Stack Developer.",
      "My developers, particularly <strong class='text-green-300 text-xl'>Madhu</strong>, are the brains behind my existence."
   ]
}
,
 {
   ...
   "responses": [
      "You can call me <strong class = 'text-xl text-green-300'>Pluto</strong>.",
      "I'm <strong class = 'text-xl text-green-300'>Pluto</strong>",
      "I am <strong class = 'text-xl text-green-300'>Pluto</strong>, a Chatbot.",
      "My name is <strong class = 'text-xl text-green-300'>Pluto</strong>, nice to meet you!",
      "I go by the name <strong class = 'text-xl text-green-300'>Pluto</strong>.",
      "Call me <strong class = 'text-xl text-green-300'>Pluto</strong>, your friendly chat companion.",
      "<strong class = 'text-xl text-green-300'>Pluto</strong> is the name I respond to.",
      "You're chatting with <strong class = 'text-xl text-green-300'>Pluto</strong>, the chatbot.",
      "I'm known as <strong class = 'text-xl text-green-300'>Pluto</strong> in the digital realm.",
      "<strong class = 'text-xl text-green-300'>Pluto</strong> is the label I go by.",
      "You can address me as <strong class = 'text-xl text-green-300'>Pluto</strong>, the chatbot.",
      "The name I answer to is <strong class = 'text-xl text-green-300'>Pluto</strong>.",
      "I am <strong class = 'text-xl text-green-300'>Pluto</strong>, your virtual conversational partner.",
      "Feel free to call me <strong class = 'text-xl text-green-300'>Pluto</strong> during our chat.",
      "<strong class = 'text-xl text-green-300'>Pluto</strong> is the identity I've adopted.",
      "I respond to the name <strong class = 'text-xl text-green-300'>Pluto</strong>.",
      "You're talking to <strong class = 'text-xl text-green-300'>Pluto</strong>, the chatbot with a name.",
      "I'm <strong class = 'text-xl text-green-300'>Pluto</strong>, the entity behind these responses.",
      "You can refer to me as <strong class = 'text-xl text-green-300'>Pluto</strong>, your chat companion.",
      "I go by the name <strong class = 'text-xl text-green-300'>Pluto</strong> in our conversation.",
      "My identity in this chat is <strong class = 'text-xl text-green-300'>Pluto</strong>.",
      "Feel free to identify me as <strong class = 'text-xl text-green-300'>Pluto</strong>, the chatbot.",
      "The label I carry is <strong class = 'text-xl text-green-300'>Pluto</strong>.",
      "I'm <strong class = 'text-xl text-green-300'>Pluto</strong>, the chatbot you're interacting with.",
      "<strong class = 'text-xl text-green-300'>Pluto</strong> is the name I go by in our conversation.",
      "You can call me <strong class = 'text-xl text-green-300'>Pluto</strong>, your virtual assistant.",
      "<strong class = 'text-xl text-green-300'>Pluto</strong> is the name that represents me.",
      "I respond to the name <strong class = 'text-xl text-green-300'>Pluto</strong> during our chat."
   ]
}
,]
